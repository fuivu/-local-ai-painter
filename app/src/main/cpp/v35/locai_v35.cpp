/**
 * Local AI Painter v3.5 Aurora — 主入口 + 综合性能测试
...
static void run_benchmark(EngineV35* eng) {
    std::cout << "\n╔══════════════════════════════════════════╗\n";
    std::cout << "║         v3.5 Aurora Performance Test         ║\n";
    std::cout << "╚══════════════════════════════════════════╝\n\n";
    ...
    // ── 总报告 ────────────────────────────────
    std::cout << "\n╔══════════════════════════════════════════╗\n";
    std::cout << "║  v3.5 vs v3.2 Expected Performance Gain:   ║\n";
    std::cout << "╠══════════════════════════════════════════╣\n";
...
int main(int argc, char** argv) {
    std::cout << "Local AI Painter v3.5 \"Aurora\"\n";
    std::cout << "================================\n\n";
