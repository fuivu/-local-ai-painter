# ============================================================
#  Local AI Painter v3.5.0 — Windows 一键编译脚本 (PowerShell)
...
Write-Host "  ║   Local AI Painter v3.5.0 Aurora Build    ║" -ForegroundColor Blue
...
if ($exitCode -eq 0) {
    ...
    if ($apkPath) {
        ...
        # 复制到根目录
        Copy-Item $apkPath.FullName "$ProjectRoot\LocalAIPainter-v3.5.0.0-$BuildType.apk" -Force
        Write-Ok "已复制到: $ProjectRoot\LocalAIPainter-v3.5.0.0-$BuildType.apk"
    }
    
    Write-Host ""
    Write-Host "  ╔════════════════════════════════════════╗" -ForegroundColor Green
    Write-Host "  ║   Local AI Painter v3.5.0 Aurora 构建完成!  ║" -ForegroundColor Green
    Write-Host "  ╚════════════════════════════════════════╝" -ForegroundColor Green
} else {
    Write-Host ""
